...
export default async function HomePage() {
  ...
  const [spotlights, celebrates, collecting] = await Promise.all([
    // Spotlight: rolling 30 days, not hidden, published
    spotlightTypeId ? supabase
      .from("ed_calendar")
      .select("ed_cal_id, title, subtitle, excerpt, slug, publish_date, free_publish_date")
    ...
    // Celebrates: rolling 30 days, not hidden, published
    ...
    // Collect: all published, not hidden, oldest first (featured = first guide)
  ...
  // For collect: featured = oldest (index 0), newest = last item gets "New" badge
  ...
  return (
    <>
      <style>{`
        ...
        .tile-ph {
          display: flex; align-items: center; justify-content: center;
          opacity: 0.2; color: var(--slate);
        }
        .guide-num {
          font-family: var(--font-display);
          font-size: 52px; line-height: 1;
          color: rgba(61,107,74,0.10);
        ...
        .tile-subtitle {
          ...
          color: var(--slate-ghost); margin-bottom: 8px; line-height: 1.4;
        }
        .tile-excerpt {
          font-size: 12px; line-height: 1.6;
          color: var(--slate-soft); flex: 1; margin-bottom: 12px;
          display: -webkit-box;
          -webkit-line-clamp: 3;
        ...
        @media (max-width: 520px) { 
          .tile-featured { flex-direction: column; grid-column: span 1; }
          .feat-sidebar { width: 100%; min-width: unset; height: 70px; }
        }
        .feat-sidebar { width: 130px; min-width: 130px; display: flex; flex-direction: column; }
        .feat-sidebar .tile-bar { width: 100%; }
        .feat-img {
          flex: 1;
          background: rgba(61,107,74,0.07);
          display: flex; align-items: center; justify-content: center;
        ...
        .feat-num {
          ...
          color: rgba(61,107,74,0.12); user-select: none;
        }
        ...
        .gate-eyebrow {
          ...
          color: var(--slate-ghost); margin-bottom: 4px;
        }
        .gate-msg {
          font-family: var(--font-display);
          font-size: 18px; color: var(--slate); margin-bottom: 3px;
        }
        ...
        .gate-btn-ghost {
          background: transparent; color: var(--slate-soft);
          ...
          <div className="hero-inner">
            <div>
              ...
              <h1 className="hero-title">
                Every card tells <span className="highlight">her story</span>
              </h1>
              <p className="hero-sub">
                The editorial home for celebrating women athletes through collecting.
                Join a community that collects with heart, celebrates with joy,
                and honors the women who made history.
              </p>
                  ...
                  <a key={item.ed_cal_id} href={`/spotlights/${item.slug}`} className="teaser-tile">
                    ...
                    <div className="tile-image img-s">
                      <div className="tile-ph">
                        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.25"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="m21 15-5-5L5 21"/></svg>
                      </div>
                    </div>
                    <div className="tile-body">
                      ...
                      <div className="tile-footer">
                        ...
                        <span className="tile-gate">
                          {access.isAuthenticated ? "Read now" : "Sign in to read"}
                        </span>
                      </div>
                    </div>
                  </a>
                      ...
                      <a key={item.ed_cal_id} href={`/collecting/${item.slug}`} className="teaser-tile tile-featured">
                        ...
                        <div className="feat-main">
                          ...
                          <div className="tile-body">
                            ...
                            <div className="tile-title feat-main-title" style={{fontSize: '19px'}}>{item.title}</div>
                            {item.subtitle && <div className="tile-subtitle">{item.subtitle}</div>}
        ...
        <div className="membership-strip">
          <div className="membership-strip-inner">
            ...
            <p className="membership-strip-sub">
              Join Chronicle or Legacy for early access, the full archive, and exclusive content
              that celebrates the women behind the cards.
            </p>

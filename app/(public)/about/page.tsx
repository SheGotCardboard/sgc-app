  ...
  return (
    <div className="sgc-page">
      ...
      <div className="cs-wrap">
        ...
        <h1 className="cs-title">Our <em>Story</em></h1>
        <p className="cs-desc">
          She Got Cardboard is the editorial home for celebrating women athletes through collecting.
          Built with heart. More coming soon.
        </p>

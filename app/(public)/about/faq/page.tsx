  ...
  return (
    <div className="sgc-page">
      ...
      <div className="cs-wrap">
        ...
        <h1 className="cs-title">Frequently Asked <em>Questions</em></h1>
        <p className="cs-desc">
          Got questions about membership, collecting, or how SGC works?
          We&apos;re putting together answers to everything. Check back soon.
        </p>

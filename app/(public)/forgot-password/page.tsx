    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-subtitle { font-size: 0.875rem; color: var(--slate-ghost); text-align: center; margin-bottom: 2rem; line-height: 1.6; }
        ...
        .auth-success { background: rgba(61,107,74,0.08); border: 1px solid rgba(61,107,74,0.2); color: var(--forest); padding: 1rem; border-radius: 8px; font-size: 0.9rem; text-align: center; line-height: 1.6; }

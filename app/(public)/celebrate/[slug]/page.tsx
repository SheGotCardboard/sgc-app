...
export default async function CelebrateArticlePage({
  ...
  const placeholderDiv = <div className="art-ph" />;
  ...
  return (
    <div className="sgc-page">
      ...
      <style>{`
        ...
        .art-kicker::before { content: ''; width: 24px; height: 2px; background: var(--lavender); display: block; }
        ...
        .art-gate-primary { background: var(--lavender); color: white; }
        ...
        .art-sidebar-item:hover { border-color: var(--lavender); background: rgba(155,136,196,0.04); }
        .art-sidebar-img-wrap { flex-shrink: 0; width: 56px; height: 78px; background: rgba(155,136,196,0.08); border-radius: 6px; overflow: hidden; display: flex; align-items: center; justify-content: center; }
        ...
        .art-sidebar-type { font-size: 9px; font-weight: 800; letter-spacing: 0.08em; text-transform: uppercase; color: var(--lavender); }
      ...
      <div className="art-wrap">
        <div className="art-layout">
          ...
          {/* ── MAIN ── */}
          <main>
            <p className="art-kicker">🏆 SGC Celebrates</p>
            ...
            {isFuture && (
              <div className="art-coming">
                ...
                <div className="art-coming-desc">This celebration drops on {formatDate(article.publish_date)}.</div>
              </div>
            )}
            ...
            {!isFuture && !canRead && !access.isAuthenticated && (
              <div className="art-gate">
                ...
                <p className="art-gate-desc">Every celebration is free with a Story account. No credit card needed.</p>
            ...
            {!isFuture && isEarlyAccess && access.isAuthenticated && !access.hasEarlyAccess && (
              <div className="art-gate">
                ...
                <p className="art-gate-desc">Chronicle and Legacy members get early access. Upgrade to read now.</p>
                <div className="art-gate-actions">
